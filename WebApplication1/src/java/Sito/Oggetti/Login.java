            ...
            for(Users u : listaUtenti)
            {
                if(u.getUsername().equals(username)&& u.getPassword().equals(password))
                {
                    ...
                    if(u instanceof UsersVenditori) 
                    {
                        ...
                        request.getRequestDispatcher("M3/Logged_seller.jsp").forward(request, response);
                    }
                    else
                    {
                        request.setAttribute("UserCliente", u);
                        request.getRequestDispatcher("M3/Logged_buyer.jsp").forward(request, response);  
                    }                    
                }
            }
        }
